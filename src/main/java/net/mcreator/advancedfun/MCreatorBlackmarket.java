...
public class MCreatorBlackmarket extends Elementsadvancedfun.ModElement {
	public static int GUIID = 3;
	public static HashMap guiinventory = new HashMap();

	public MCreatorBlackmarket(Elementsadvancedfun instance) {
		super(instance, 15);
	}
	...
	public static class GuiWindow extends GuiContainer {
		...
		private static final ResourceLocation texture = new ResourceLocation("advancedfun:textures/blackmarket.png");
		...
		public void initGui() {
			...
			this.buttonList.add(new GuiButton(0, this.guiLeft + 7, this.guiTop + 6, 120, 20, "Buy Cocainer"));
		}
		...
		if (buttonID == 0) {
			{
				...
				MCreatorBmcobuy.executeProcedure($_dependencies);
			}
		}
	}
