...
public class MCreatorCocainergui extends Elementsadvancedfun.ModElement {
	public static int GUIID = 2;
	public static HashMap guiinventory = new HashMap();
	public static IInventory Inv2;

	public MCreatorCocainergui(Elementsadvancedfun instance) {
		super(instance, 9);
	}
	...
	public static class GuiContainerMod extends Container {
		...
		public GuiContainerMod(World world, int x, int y, int z, EntityPlayer player) {
			...
			this.y = y;
			this.z = z;
			Inv2 = new InventoryBasic("Inv2", true, 9);
			guiinventory.put("Inv2", Inv2);
			int si;
			int sj;
			for (si = 0; si < 3; ++si)
				for (sj = 0; sj < 9; ++sj)
		...
		public void onContainerClosed(EntityPlayer playerIn) {
			...
			InventoryHelper.dropInventoryItems(world, new BlockPos(x, y, z), Inv2);
		}
	...
	public static class GuiWindow extends GuiContainer {
		...
		private static final ResourceLocation texture = new ResourceLocation("advancedfun:textures/cocainergui.png");
		...
		protected void drawGuiContainerForegroundLayer(int par1, int par2) {
			this.fontRenderer.drawString("Cocainer", 67, 6, -16777216);
		}
		...
		public void initGui() {
			...
			this.buttonList.add(new GuiButton(0, this.guiLeft + 59, this.guiTop + 26, 60, 20, "Create"));
		}
		...
		if (buttonID == 0) {
			{
				...
				MCreatorCocainecrafter.executeProcedure($_dependencies);
			}
		}
	}
